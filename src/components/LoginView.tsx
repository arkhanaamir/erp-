                ...
                <form onSubmit={handleLoginSubmit} className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <button
                      ...
                      className="w-full flex items-center justify-center space-x-2.5 rounded-xl border border-zinc-700 hover:border-amber-500/50 bg-zinc-900/90 hover:bg-zinc-800/80 px-4 py-2.5 text-xs font-semibold text-zinc-200 hover:text-white transition shadow-sm"
                    >
                    ...
                    <button
                      ...
                      onClick={async () => {
                        ...
                        try {
                          ...
                          setErrorMsg(err.message || 'Direct cloud session failed. Please authorize domain in Firebase Console.');
                        }
                      }}
                      className="w-full flex items-center justify-center space-x-2 rounded-xl border border-zinc-800 hover:border-zinc-700 bg-zinc-950/70 hover:bg-zinc-900/90 px-4 py-2 text-[11px] font-medium text-zinc-400 hover:text-zinc-200 transition"
                    >
